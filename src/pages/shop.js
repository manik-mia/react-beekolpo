            ...
            <div className="grid grid-cols-1 md:grid-cols-[1fr_4fr]  gap-10  w-full ">
                ...
                <div>
                    <div className="">
                        ...
                        <button className="text-[#585858]">Fashion</button>{" "}
                        <br />
                        <button className="text-[#FF5757]">
                            Home & Garden
                        </button>
                        <br />
                    ...
                    <div>
                        ...
                        <div className="flex gap-2  mt-4">
                            ...
                            <button className="bg-[#FF5757]  px-3 py-1 rounded">
                                Go
                            </button>
                        </div>
                    </div>
